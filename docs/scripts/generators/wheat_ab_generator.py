...
<body>
    {nav}
					...
					<li class="pure-menu-item"><a href="trees/wheat_AB_trees.txt" class="nav_link" download>Gene trees</a></li>
					<li class="pure-menu-item"><a href="output/wheat_AB_A_out.txt" class="nav_link" download>Main output table</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="pure-u-20-24" id="results_col">
			<div class="pure-g">
				...
				<div class="pure-u-12-24">
					...
					<img class="pure-img" id="logo_main" src="img/wheat_AB_mul.png">
