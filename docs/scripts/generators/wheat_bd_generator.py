...
<body>
    {nav}
					...
					<li class="pure-menu-item"><a href="trees/wheat_D.tre" class="nav_link" download>Species tree</a></li>
					<li class="pure-menu-item"><a href="trees/wheat_AD_trees.txt" class="nav_link" download>Gene trees</a></li>
					<li class="pure-menu-item"><a href="output/wheat_BD_D_out.txt" class="nav_link" download>Main output table</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="pure-u-20-24" id="results_col">
			<div class="pure-g">
				<div class="pure-u-12-24">
					...
					<img class="pure-img" id="logo_main" src="img/wheat_D_phylo.png">
				...
				<div class="pure-u-12-24">
					...
					<img class="pure-img" id="logo_main" src="img/wheat_BD_mul.png">
			...
			<div class="pure-g">
				<div class="pure-u-1">
					...
					<h2>Score plot with alternate species topology</h2>
					<center>
					{p2}
					</center>
				</div>
