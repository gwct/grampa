			...
			<div id="main_content">
				...
				<h2>Install</h2>
					...
					<div class="row">
						<div class="col-7-24 margin"></div>
						<div class="col-10-24" id="install">
							<center><pre class="cmd"><code>grampa</code></pre></center>
						</div>
						<div class="col-7-24 margin"></div>
					</div>

					<p>
						For other usage instructions and instructions for installing from source, see the <a href="readme.html">README</a>.
					</p>
