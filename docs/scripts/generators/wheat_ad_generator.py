...
<body>
    {nav}
					...
					<li class="pure-menu-item"><a href="output/wheat_AD_A_out.txt" class="nav_link" download>Main output table</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="pure-u-20-24" id="results_col">
			<div class="pure-g">
				...
				<div class="pure-u-12-24">
					...
					<img class="pure-img" id="logo_main" src="img/wheat_AD_mul.png">
