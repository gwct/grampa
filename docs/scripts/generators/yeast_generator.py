				...
				<div class="row">
					...
					<div class="col-1" id="jump_row">
						<div id="jump_container">
							...
							<a class="jump_link" href="trees/yeast_trees_final.txt" download>Gene trees</a>
							<a class="jump_link" href="output/yeast_out.txt" download>Main output table</a>
							<a class="jump_link" href="yeast_ohno.html">Ohnolog results</a>
							</center>
						</div>
					</div>
				</div>					
