...
# This generates the file "yeast.html"
############################################################
...
<body>
    {nav}
					...
					<li class="pure-menu-item"><a href="trees/yeast_trees_final.txt" class="nav_link" download>Gene trees</a></li>
					<li class="pure-menu-item"><a href="output/yeast_out.txt" class="nav_link" download>Main output table</a></li>
				</ul>
			</div>
		</div>
		...
		<div class="pure-u-20-24" id="results_col">
			<div class="pure-g">
				<div class="pure-u-12-24">
					...
					<h3>3,987 trees after filtering</h3>
				</div>
				<div class="pure-u-12-24">
